...
#################################################
# file to edit: _notebooks/2022-10-03-AP-error_testing copy.ipynb
-->
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>The letter d is the 3 letter in the alphabet
</pre>
</div>
</div>
...
<span class="k">while</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">count</span><span class="p">:</span>
    <span class="n">item</span> <span class="o">=</span> <span class="nb">input</span><span class="p">(</span><span class="s2">&quot;Please select from the menu&quot;</span><span class="p">)</span>
...
<span class="ansi-green-intense-fg ansi-bold">      9</span>     print(k + &#34;  $&#34; + str(v)) #why does v have &#34;str&#34; in front of it?
<span class="ansi-green-intense-fg ansi-bold">     11</span> #ideally the code should prompt the user multiple times
<span class="ansi-green-fg">---&gt; 12</span> count = int(input(&#34;How many items do you want?&#34;))
<span class="ansi-green-intense-fg ansi-bold">     13</span> i = 0
<span class="ansi-green-intense-fg ansi-bold">     14</span> print(&#34;Your order&#34;)

<span class="ansi-red-fg">ValueError</span>: invalid literal for int() with base 10: &#39;burger&#39;</pre>
</div>
</div>
