...
show_tags: true
comments: true
nb_path: _notebooks/2022-09-2-infoDB CORRECT.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-09-2-infoDB CORRECT.ipynb
-->
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Print-Function-and-While-Loop/Recursion-(More-List-Methods)">Print Function and While Loop/Recursion (More List Methods)<a class="anchor-link" href="#Print-Function-and-While-Loop/Recursion-(More-List-Methods)"> </a></h2>
</div>
</div>
</div>
    {% raw %}
...
<span class="c1"># while loop algorithm contains an initial n and an index incrementing statement (n += 1)</span>
